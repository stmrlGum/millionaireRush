...
final class StopwatchView: UIView {
    ...
    private func updateAppearance() {
        ...
        case 0...5:
            updateTimerState(UIColor.red.withAlphaComponent(0.3), .red, .red)
        case 6...15:
            updateTimerState(UIColor.orange.withAlphaComponent(0.3), .orange, .orange)
        default:
            updateTimerState(UIColor.white.withAlphaComponent(0.3), .white, .white)
        }
    }
    
    private func updateTimerState(_ backroundColor: UIColor, _ textColor: UIColor, _ tintColor: UIColor) {
        containerView.backgroundColor = backroundColor
